...
\title[Short title]{Software Requirement Specication } % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Jean-Philippe Eisenbarth} % Your name
\institute[UCLA] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
University of California \\ % Your institution for the title page
\medskip
\textit{jp@eisenbarth.io} % Your email address
}
...
%------------------------------------------------
\section{Revision History} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
\bibitem[1]{p1} J.Liu and G. Mei and  X.Wu and J.Lu 
